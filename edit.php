...
--><div class="container">
	  	<fieldset>
                 <form id="ajax-contact" action="update.php?id=<?php echo $id; ?>" method="post"><br>
		...
		<span class="input-group-addon">
		   <span class="glyphicon glyphicon-calendar"><i class="fa fa-profile" aria-hidden="true"></i></span>
              ...
              <div class><input type="text" class="form-control"id="email" name="email" placeholder="john@example.com" style=" width:20%;height:30px;padding: 6px 9px;font-size: 19px; line-height: 1.428571429;border-radius: 8px; background-color:lightblue;" required></div>  <br>
                  <label for="states">State of event:</label><br>
        <div class >  <select name="states" id="states" style=" width: 20%; height: 34px; padding: 6px 9px; font-size: 19px;line-height: 1.428571429;border-radius: 4px; background-color:lightblue;" required>
...
-->
			   ...
			   <div class><select name="event" id="apartment" class="form-control"style=" width: 20%;height: 34px;padding: 6px 9px;font-size: 19px;line-height: 1.428571429; border-radius: 8px; background-color:lightblue;" required>
				...
				<div class><input type="text" id="rooms" name="rooms"class="form-control" placeholder="e.g seat40"style=" width: 20%;height: 30px; padding: 6px 9px;font-size: 19px;line-height: 1.428571429;border-radius: 8px; background-color:lightblue;" required></div><br>
                <label for="name">Preferred Event Date:</label>
		   <div class='input-group date' id='datetimepicker'>
	   
             <input type="text" id="date"name="date"  class="form-control datetimepicker" placeholder="date/month/year"style=" width: 20%;height: 30px;padding: 6px 9px;font-size: 19px; line-height: 1.428571429; border-radius: 10px; background-color:lightblue;" required>
<span class="input-group-addon">
